...
| drivaernet | 汽车表面阻力预测（DrivAerNet） | https://github.com/PaddlePaddle/PaddleScience/tree/develop/examples/drivaernet | [DrivAerNet](https://paddlescience-docs.readthedocs.io/zh-cn/latest/examples/drivaernet/) | [DriverNet](./DriverNet/REAME.md) |
